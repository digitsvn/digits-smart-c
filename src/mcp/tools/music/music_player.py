...
class MusicPlayer:
    ...
    async def _fetch_lyrics(self, song_id: str):
        ...
        try:
            ...
            # Xây dựng yêu cầu API lời bài hát
            ...
            if (
                ...
                # Phân tích lời bài hát định dạng LRC
                ...
                for line in lines:
                    ...
                    # Khớp định dạng thẻ thời gian [mm:ss.xx]
                    import re
                    ...
                    if time_match:
                        ...
                        # Bỏ qua lời bài hát trống và lời bài hát thông tin meta
                        if (
                            text
                ...
                logger.warning(f"Không lấy được lời bài hát hoặc định dạng sai: {data.get('msg', '')}")
